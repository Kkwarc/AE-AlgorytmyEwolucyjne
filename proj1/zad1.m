...
for k=1:length(X)
    ...
    [xsol,fval,history,info] = runfmincon('fminunc', 'quasi-newton', 'None', 'None', [x, y], [a, b], i);
    i = i + i;
...
%     % fminunc #2 Quasi Newton Gradient supplied
    [xsol,fval,history,info] = runfmincon('fminunc', 'quasi-newton', 'on', 'None', [x, y], [a, b], i);
    i = i + 1;
    ...
    [xsol,fval,history,info] = runfmincon('fminunc', 'trust-region', 'On', 'None', [x, y], [a, b], i);
    i = i + 1;
...
%    fminunc #4 fminsearch
    [xsol,fval,history,info] = runfmincon('fminsearch', 'None', 'None', 'None', [x, y], [a, b], i); 
    i = i + 1;
    disp('fminsearch')
    disp(['Point: ', num2str(xsol)])
    disp(['MinValue: ', num2str(fval)])
